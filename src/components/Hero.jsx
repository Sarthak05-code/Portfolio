          ...
          <div className="p-lg md:p-xl">
            ...
            <div className="mb-lg">
              ...
              <h1 className="font-mono text-4xl md:text-5xl lg:text-6xl font-bold text-primary tracking-tight">
                {displayText}
                <span className="inline-block w-0.75 h-[0.9em] bg-primary-container animate-blink align-baseline ml-1" />
              </h1>
            </div>
              ...
              <div className="flex flex-col-reverse md:flex-row gap-lg items-start">
                ...
                <div className="flex-1">
                  <p className="text-on-surface-variant leading-relaxed max-w-2xl mb-lg text-sm md:text-base">
                    I’m passionate about backend development and DevOps, with a
                    focus on building robust, scalable systems and understanding
                    the infrastructure that powers them. I enjoy working with
                    Docker, CI/CD pipelines, and databases while continuously
                    exploring clean architecture, automation, and system
                    reliability. My goal is to build practical, reliable tools
                    that developers genuinely enjoy using.
                  </p>
                ...
                <div className="shrink-0 mx-auto md:mx-0">
                  <div className="relative w-36 h-36 md:w-44 md:h-44 rounded-xl overflow-hidden border-2 border-outline-variant hover:border-primary-container/60 transition-all duration-300 group">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t from-surface-container-lowest/60 to-transparent" />
                  </div>
                </div>
              </div>
            </div>
